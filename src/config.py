...
def parse_args():
    ...
    parser.add_argument('--dropout', type=float, default=0.2, help='dropout ratio') # 0.3
    parser.add_argument('--ema_decay', type=float, default=0.985, help='dropout ratio') # 0.3
    parser.add_argument('--weight',type=str,default=None)#'/content/drive/MyDrive/weixin_bigdata/data/saved_models/model_epoch_2_mean_f1_0.6577.bin') 
    # ========================= Pretrain Configs =======================
    parser.add_argument('--pretrained_path',type=str,default='../pretrained_models/last.bin')
    parser.add_argument('--pretrain_learning_rate', default=5e-5,type=float)
    parser.add_argument('--pretrain', default=True,type=bool)
    parser.add_argument('--pretrain_epochs', default=10,type=int)
    parser.add_argument('--distill', default=True,type=bool)
    parser.add_argument('--albef', default=True,type=bool)
    parser.add_argument('--pretrain_datapath', default='../data/clustered_feats/',type=str)
    ...
    parser.add_argument('--train_zip_feats', type=str, default='../data/labeled.npy')
    parser.add_argument('--test_zip_feats', type=str, default='../data/testb.npy')
    ...
    parser.add_argument('--batch_size', default=40, type=int, help="use for training duration per worker")
    ...
    parser.add_argument("--gradient_acc_step", default=25, type=int, help="gradient accumulation steps")
    parser.add_argument('--prefetch', default=0, type=int, help="use for training duration per worker")
    parser.add_argument('--num_workers', default=0, type=int, help="num_workers for dataloaders")

    # ======================== SavedModel Configs =========================
    parser.add_argument('--savedmodel_path', type=str, default='../finetune_models')
    parser.add_argument('--ckpt_file', type=str, default='/content/drive/MyDrive/weixin_bigdata/data/saved_models/model_epoch_3_mean_f1_0.9354newfold42.bin')
